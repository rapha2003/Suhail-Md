...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/5d9fa1b9bd8989891bddc.jpg" ; // SET LOGO FOR IMAGE 
...
module.exports = {
  ...
  WORKTYPE: process.env.WORKTYPE || process.env.MODE|| "punlic",
